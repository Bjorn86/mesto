...
// EDIT AVATAR POPUP VARIABLES
export const editAvatarPopupSelector = '.popup_type_avatar-edit';
export const editAvatarPopupElement = document.querySelector('.popup_type_avatar-edit');

// DELETE CARD POPUP VARIABLES
export const deleteCardPopupSelector = '.popup_type_card-delete-confirmation';
...
export const editProfileButtonElement = profileElement.querySelector('.profile__btn-avatar-edit')
